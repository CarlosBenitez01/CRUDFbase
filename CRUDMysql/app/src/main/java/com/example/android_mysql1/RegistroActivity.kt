...
class RegistroActivity : AppCompatActivity() {
    ...
    fun cargarDatos(){
        ...
        val url = "http://192.168.1.55/android_mysql1/registro.php?id=$id"
    ...
    fun eliminar(Vista: View){
        val url = "http://192.168.1.55/android_mysql1/eliminar.php"
        procesoEnCola= Volley.newRequestQueue(this)
        var resultadoPost = object : StringRequest(Request.Method.POST,url,
            Response.Listener { Respuesta->
                ...
                Toast.makeText(this,"Error al eliminar al usuario",Toast.LENGTH_LONG).show()
            }){
    ...
    fun editar(Vista: View){
        val url = "http://192.168.1.55/android_mysql1/editar.php"
        procesoEnCola = Volley.newRequestQueue(this)
        val resultadoPost = object : StringRequest(Request.Method.POST,url,
            Response.Listener { respuesta->
                Toast.makeText(this,"Usuario editado",Toast.LENGTH_LONG).show()
            },Response.ErrorListener { error->
                Toast.makeText(this,"Error al edidar al usuario",Toast.LENGTH_LONG).show()
            }){
            override fun getParams(): MutableMap<String, String>? {
                val parametros = HashMap<String,String>()
                parametros.put("id",etId.text.toString())
